...
var image="himagefall/schnee.png";  //Image path should be given here
...
for (i = 0; i < no; ++ i) {  
	...
	document.write("<div class='dot' id=\"dot"+ i +"\" style=\"POSITION: absolute; Z-INDEX: "+ i +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+image+"' border=\"0\"><\/div>");
}
